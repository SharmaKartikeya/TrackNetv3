...
class TrackNetv2Agent(BaseAgent):
    def __init__(self, config):
        super(TrackNetv2Agent, self).__init__(config)
        ...
        print('Loss using zeros: ', self.loss(torch.zeros_like(self.heatmaps), self.heatmaps), '\n')
